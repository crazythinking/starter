...
public class RingBufferAutoConfiguration {
	...
	public RingBuffer<AbstractDisruptorEvent> ringBuffer(DisruptorProperties properties, WaitStrategy waitStrategy,
	...
	)
	{
		 ...
		 */
		RingBuffer<AbstractDisruptorEvent> ringBuffer;
		...
		//	// 创建消息处理器
		//	BatchEventProcessor<AbstractDisruptorEvent> transProcessor = new BatchEventProcessor<>(ringBuffer,
